...
WITH terms AS (
	...
	UNION ALL SELECT 'CLE', 'Grover Cleveland'		DATE '1885-03-04', DATE '1889-03-04', 'Republican' 			      FROM DUAL
    UNION ALL SELECT 'BH',  'Benjamin Harrison'		DATE '1889-03-04', DATE '1893-03-04', 'Democrat' 			      FROM DUAL
...
WITH terms AS (
	...
	UNION ALL SELECT 'CLE', 'Grover Cleveland'		DATE '1885-03-04', DATE '1889-03-04', 'Republican' 			      
    UNION ALL SELECT 'BH',  'Benjamin Harrison'		DATE '1889-03-04', DATE '1893-03-04', 'Democrat' 			      
